...
export const script: ScriptCommand[] =
  [
    ...
    { cmd: 'image', id: 'character', src: './image/char/char.webp', tween: { y: 960, width: 700, height: 1400, opacity: 0, scale: 1.2 } },
    { cmd: 'image.to', id: 'character', tween: { opacity: 1, scale: 1.3, duration: 0.5 }, wait: true },
